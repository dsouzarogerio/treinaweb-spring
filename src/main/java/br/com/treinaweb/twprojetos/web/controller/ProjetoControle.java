...
public class ProjetoControle {
    ...
    public String salvar(@Valid Projeto projeto, BindingResult resultado
    ...
    public String excluir(@PathVariable Long id, RedirectAttributes attrs) {
        ...
        attrs.addFlashAttribute("alert", new AlertDTO("Projeto excluído com sucesso!", "alert-success"));
    ...
    private void popularFormulario(ModelAndView modelAndView) {
        ...
        modelAndView.addObject("lideres", funcionarioServico.buscarLider());
    ...
    private void popularFormulario(ModelMap model) {
		...
		model.addAttribute("lideres", funcionarioServico.buscarLider());
