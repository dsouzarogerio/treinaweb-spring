...
public class FuncionarioControle {
    ...
    public String cadastrar(@Valid Funcionario funcionario, 
    ...
    public String editar(@Valid Funcionario funcionario, 
    					BindingResult resultado, 
    ...
    public String excluir(@PathVariable Long id, RedirectAttributes attrs) {
        try {
        	...
        	attrs.addFlashAttribute("alert", new AlertDTO("Funcionário não pdoe ser excluído pois é lider de algum projeto.", "alert-danger"));
        }
