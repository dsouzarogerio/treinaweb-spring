...
public class ClienteControle {
    ...
    public String salvar(@Valid Cliente cliente, BindingResult resultado, 
    		RedirectAttributes attr, @PathVariable(required = false) Long id) {
    ...
    public String excluir(@PathVariable Long id, RedirectAttributes attr) {
    	...
    	try {
    		...
    		attr.addFlashAttribute("alert", new AlertDTO("Cliente não pode ser excluído, pois possui projeto(s) relacionado(s).", "alert-danger"));
    	}
